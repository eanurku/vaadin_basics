package com.vaadincrm.backend.service;

import com.vaadincrm.backend.Company;
import com.vaadincrm.backend.Contact;
import com.vaadincrm.backend.repository.CompanyRepository;
import com.vaadincrm.backend.repository.ContactRepository;
            ...
            contactRepository.saveAll(
                    Stream.of("Gabrielle Patel", "Brian Robinson", "Eduardo Haugen",
                            ...
                            .map(name -> {
                                ...
                                String email =
                                        (contact.getFirstName() + "." + contact.getLastName() + "@" + contact.getCompany().getName()
